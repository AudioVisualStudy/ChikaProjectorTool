...
namespace com.yugop.chikaprojector {

// 実解像度で描いた映像を、4K 出力用の上下 2 段レイアウトへ変換する。
[ExecuteAlways]
[DisallowMultipleComponent]
public class ChikaProjector4KMapper : MonoBehaviour {
    // --- インスペクタ設定 ---
    ...
    private const string RenderTextureName = "ChikaProjector4KMapper Design Texture";
    private const string DisplayRootName = "ChikaProjector4KMapper Display";
    private const string TopQuadName = "ChikaProjector4KMapper Top Half";
    private const string BottomQuadName = "ChikaProjector4KMapper Bottom Half";
    ...
    private void EnsureDisplayObjects() {
        ...
        EnsureDisplayMaterial(ref topMaterial, "ChikaProjector4KMapper Top Material", new Vector2(0.5f, 1f), Vector2.zero);
        EnsureDisplayMaterial(ref bottomMaterial, "ChikaProjector4KMapper Bottom Material", new Vector2(0.5f, 1f), new Vector2(0.5f, 0f));
    ...
    private void EnsureDisplayCamera() {
        ...
        GameObject cameraObject = new GameObject("ChikaProjector4KMapper Display Camera");
